...
export function Topbar() {
  ...
  return (
    <header className="border-b border-border bg-card px-4 py-2 md:flex md:h-14 md:items-center md:justify-between md:px-6 md:py-0">
      ...
      <div className="mx-3 hidden flex-1 justify-center md:flex">
        <GlobalSearch />
      </div>
