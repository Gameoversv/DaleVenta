...
export default function AuditPage() {
  ...
  if (!canViewAudit) {
    return <PermissionDenied title="Auditoria" message="No tienes permiso para ver auditoria." />;
  }
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          ...
          {isError && <ErrorState message="No se pudo cargar la auditoria." />}
          {!isLoading && logs.length === 0 && <EmptyState message="No hay eventos para este filtro." />}
          {logs.length > 0 && (
