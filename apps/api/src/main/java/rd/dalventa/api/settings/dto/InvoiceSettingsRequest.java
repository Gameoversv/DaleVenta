...
// (V4__tenants.sql). Sin ellos el valor llega a Postgres y el rechazo del
// motor sale como 500 en vez de un 400 que le diga al usuario que acortar.
public record InvoiceSettingsRequest(
        ...
        @Size(max = 20, message = "El telefono no puede pasar de 20 caracteres") String phone,
